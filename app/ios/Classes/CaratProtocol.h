...
@interface NetworkDetails : NSObject <TBase, NSCoding> {
  ...
  NSString * __networkOperator;
  NSString * __simOperator;
  NSString * __mcc;
  NSString * __mnc;
  ...
  BOOL __networkOperator_isset;
  BOOL __simOperator_isset;
  BOOL __mcc_isset;
  BOOL __mnc_isset;
}
...
@property (nonatomic, retain, getter=networkOperator, setter=setNetworkOperator:) NSString * networkOperator;
@property (nonatomic, retain, getter=simOperator, setter=setSimOperator:) NSString * simOperator;
@property (nonatomic, retain, getter=mcc, setter=setMcc:) NSString * mcc;
@property (nonatomic, retain, getter=mnc, setter=setMnc:) NSString * mnc;
#endif
...
@interface StorageDetails : NSObject <TBase, NSCoding> {
  int32_t __free;
  int32_t __total;
