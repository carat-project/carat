  ...
  if (__appSignatures_isset) {
    if (__appSignatures != nil) {
      [outProtocol writeFieldBeginWithName: @"appSignatures" type: TType_LIST fieldID: 8];
      {
        ...
        int i4;
        for (i4 = 0; i4 < [__appSignatures count]; i4++)
        {
          [outProtocol writeString: [__appSignatures objectAtIndex: i4]];
        }
  ...
  if (__piList_isset) {
    if (__piList != nil) {
      [outProtocol writeFieldBeginWithName: @"piList" type: TType_LIST fieldID: 3];
      {
        ...
        int i15;
        for (i15 = 0; i15 < [__piList count]; i15++)
        {
          [[__piList objectAtIndex: i15] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__locationProviders_isset) {
    if (__locationProviders != nil) {
      [outProtocol writeFieldBeginWithName: @"locationProviders" type: TType_LIST fieldID: 18];
      {
        ...
        int i17;
        for (i17 = 0; i17 < [__locationProviders count]; i17++)
        {
          [outProtocol writeString: [__locationProviders objectAtIndex: i17]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__extra_isset) {
    if (__extra != nil) {
      [outProtocol writeFieldBeginWithName: @"extra" type: TType_LIST fieldID: 24];
      {
        ...
        int i19;
        for (i19 = 0; i19 < [__extra count]; i19++)
        {
          [[__extra objectAtIndex: i19] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__xVals_isset) {
    if (__xVals != nil) {
      [outProtocol writeFieldBeginWithName: @"xVals" type: TType_LIST fieldID: 2];
      {
        ...
        int i27;
        for (i27 = 0; i27 < [__xVals count]; i27++)
        {
          [outProtocol writeDouble: [[__xVals objectAtIndex: i27] doubleValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__yVals_isset) {
    if (__yVals != nil) {
      [outProtocol writeFieldBeginWithName: @"yVals" type: TType_LIST fieldID: 3];
      {
        ...
        int i29;
        for (i29 = 0; i29 < [__yVals count]; i29++)
        {
          [outProtocol writeDouble: [[__yVals objectAtIndex: i29] doubleValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__xVals_isset) {
    if (__xVals != nil) {
      [outProtocol writeFieldBeginWithName: @"xVals" type: TType_LIST fieldID: 3];
      {
        [outProtocol writeListBeginWithElementType: TType_DOUBLE size: [__xVals count]];
        int i43;
        for (i43 = 0; i43 < [__xVals count]; i43++)
        {
          [outProtocol writeDouble: [[__xVals objectAtIndex: i43] doubleValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__yVals_isset) {
    if (__yVals != nil) {
      [outProtocol writeFieldBeginWithName: @"yVals" type: TType_LIST fieldID: 4];
      {
        [outProtocol writeListBeginWithElementType: TType_DOUBLE size: [__yVals count]];
        int i45;
        for (i45 = 0; i45 < [__yVals count]; i45++)
        {
          [outProtocol writeDouble: [[__yVals objectAtIndex: i45] doubleValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__xValsWithout_isset) {
    if (__xValsWithout != nil) {
      [outProtocol writeFieldBeginWithName: @"xValsWithout" type: TType_LIST fieldID: 5];
      {
        ...
        int i47;
        for (i47 = 0; i47 < [__xValsWithout count]; i47++)
        {
          [outProtocol writeDouble: [[__xValsWithout objectAtIndex: i47] doubleValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__yValsWithout_isset) {
    if (__yValsWithout != nil) {
      [outProtocol writeFieldBeginWithName: @"yValsWithout" type: TType_LIST fieldID: 6];
      {
        ...
        int i49;
        for (i49 = 0; i49 < [__yValsWithout count]; i49++)
        {
          [outProtocol writeDouble: [[__yValsWithout objectAtIndex: i49] doubleValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__hbList_isset) {
    if (__hbList != nil) {
      [outProtocol writeFieldBeginWithName: @"hbList" type: TType_LIST fieldID: 2];
      {
        ...
        int i54;
        for (i54 = 0; i54 < [__hbList count]; i54++)
        {
          [[__hbList objectAtIndex: i54] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__features_isset) {
    if (__features != nil) {
      [outProtocol writeFieldBeginWithName: @"features" type: TType_LIST fieldID: 2];
      {
        ...
        int i59;
        for (i59 = 0; i59 < [__features count]; i59++)
        {
          [[__features objectAtIndex: i59] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__features_isset) {
    if (__features != nil) {
      [outProtocol writeFieldBeginWithName: @"features" type: TType_LIST fieldID: 2];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__features count]];
        int i64;
        for (i64 = 0; i64 < [__features count]; i64++)
        {
          [[__features objectAtIndex: i64] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__processList_isset) {
    if (__processList != nil) {
      [outProtocol writeFieldBeginWithName: @"processList" type: TType_LIST fieldID: 2];
      {
        ...
        int i69;
        for (i69 = 0; i69 < [__processList count]; i69++)
        {
          [outProtocol writeString: [__processList objectAtIndex: i69]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (void) send_getReports: (NSString *) uuId features: (FeatureList) features
{
  ...
  if (features != nil)  {
    [outProtocol writeFieldBeginWithName: @"features" type: TType_LIST fieldID: 2];
    {
      ...
      int i71;
      for (i71 = 0; i71 < [features count]; i71++)
      {
        [[features objectAtIndex: i71] write: outProtocol];
      }
      [outProtocol writeListEnd];
    }
    [outProtocol writeFieldEnd];
...
- (void) send_getHogOrBugReport: (NSString *) uuId features: (FeatureList) features
{
  ...
  if (features != nil)  {
    [outProtocol writeFieldBeginWithName: @"features" type: TType_LIST fieldID: 2];
    {
      [outProtocol writeListBeginWithElementType: TType_STRUCT size: [features count]];
      int i73;
      for (i73 = 0; i73 < [features count]; i73++)
      {
        [[features objectAtIndex: i73] write: outProtocol];
      }
      [outProtocol writeListEnd];
    }
    [outProtocol writeFieldEnd];
...
- (void) send_getQuickHogsAndMaybeRegister: (Registration *) registration processList: (NSMutableArray *) processList
{
  ...
  if (processList != nil)  {
    [outProtocol writeFieldBeginWithName: @"processList" type: TType_LIST fieldID: 2];
    {
      ...
      int i75;
      for (i75 = 0; i75 < [processList count]; i75++)
      {
        [outProtocol writeString: [processList objectAtIndex: i75]];
      }
      [outProtocol writeListEnd];
    }
    [outProtocol writeFieldEnd];
