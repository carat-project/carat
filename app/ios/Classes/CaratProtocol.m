...
- (id) initWithNetworkType: (NSString *) networkType mobileNetworkType: (NSString *) mobileNetworkType mobileDataStatus: (NSString *) mobileDataStatus mobileDataActivity: (NSString *) mobileDataActivity roamingEnabled: (BOOL) roamingEnabled wifiStatus: (NSString *) wifiStatus wifiSignalStrength: (int32_t) wifiSignalStrength wifiLinkSpeed: (int32_t) wifiLinkSpeed networkStatistics: (NetworkStatistics *) networkStatistics wifiApStatus: (NSString *) wifiApStatus networkOperator: (NSString *) networkOperator simOperator: (NSString *) simOperator mcc: (NSString *) mcc mnc: (NSString *) mnc
{
  ...
  __networkOperator = [networkOperator retain_stub];
  __networkOperator_isset = YES;
  __simOperator = [simOperator retain_stub];
  __simOperator_isset = YES;
  __mcc = [mcc retain_stub];
  __mcc_isset = YES;
  __mnc = [mnc retain_stub];
  __mnc_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"networkOperator"])
  {
    __networkOperator = [[decoder decodeObjectForKey: @"networkOperator"] retain_stub];
    __networkOperator_isset = YES;
  }
  if ([decoder containsValueForKey: @"simOperator"])
  {
    __simOperator = [[decoder decodeObjectForKey: @"simOperator"] retain_stub];
    __simOperator_isset = YES;
  }
  if ([decoder containsValueForKey: @"mcc"])
  {
    __mcc = [[decoder decodeObjectForKey: @"mcc"] retain_stub];
    __mcc_isset = YES;
  }
  if ([decoder containsValueForKey: @"mnc"])
  {
    __mnc = [[decoder decodeObjectForKey: @"mnc"] retain_stub];
    __mnc_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__networkOperator_isset)
  {
    [encoder encodeObject: __networkOperator forKey: @"networkOperator"];
  }
  if (__simOperator_isset)
  {
    [encoder encodeObject: __simOperator forKey: @"simOperator"];
  }
  if (__mcc_isset)
  {
    [encoder encodeObject: __mcc forKey: @"mcc"];
  }
  if (__mnc_isset)
  {
    [encoder encodeObject: __mnc forKey: @"mnc"];
  }
}
...
- (void) dealloc
{
  ...
  [__networkOperator release_stub];
  [__simOperator release_stub];
  [__mcc release_stub];
  [__mnc release_stub];
  [super dealloc_stub];
}
...
- (NSString *) networkOperator {
  return [[__networkOperator retain_stub] autorelease_stub];
}

- (void) setNetworkOperator: (NSString *) networkOperator {
  [networkOperator retain_stub];
  [__networkOperator release_stub];
  __networkOperator = networkOperator;
  __networkOperator_isset = YES;
}

- (BOOL) networkOperatorIsSet {
  return __networkOperator_isset;
}

- (void) unsetNetworkOperator {
  [__networkOperator release_stub];
  __networkOperator = nil;
  __networkOperator_isset = NO;
}

- (NSString *) simOperator {
  return [[__simOperator retain_stub] autorelease_stub];
}

- (void) setSimOperator: (NSString *) simOperator {
  [simOperator retain_stub];
  [__simOperator release_stub];
  __simOperator = simOperator;
  __simOperator_isset = YES;
}

- (BOOL) simOperatorIsSet {
  return __simOperator_isset;
}

- (void) unsetSimOperator {
  [__simOperator release_stub];
  __simOperator = nil;
  __simOperator_isset = NO;
}

- (NSString *) mcc {
  return [[__mcc retain_stub] autorelease_stub];
}
...
- (NSString *) mnc {
  return [[__mnc retain_stub] autorelease_stub];
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 11:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setNetworkOperator: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      case 12:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setSimOperator: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__networkOperator_isset) {
    if (__networkOperator != nil) {
      [outProtocol writeFieldBeginWithName: @"networkOperator" type: TType_STRING fieldID: 11];
      [outProtocol writeString: __networkOperator];
      [outProtocol writeFieldEnd];
    }
  }
  if (__simOperator_isset) {
    if (__simOperator != nil) {
      [outProtocol writeFieldBeginWithName: @"simOperator" type: TType_STRING fieldID: 12];
      [outProtocol writeString: __simOperator];
      [outProtocol writeFieldEnd];
    }
  }
  if (__mcc_isset) {
    if (__mcc != nil) {
      [outProtocol writeFieldBeginWithName: @"mcc" type: TType_STRING fieldID: 13];
      [outProtocol writeString: __mcc];
      [outProtocol writeFieldEnd];
    }
  }
  if (__mnc_isset) {
    if (__mnc != nil) {
      [outProtocol writeFieldBeginWithName: @"mnc" type: TType_STRING fieldID: 14];
      [outProtocol writeString: __mnc];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  ...
  [ms appendString: @",networkOperator:"];
  [ms appendFormat: @"\"%@\"", __networkOperator];
  [ms appendString: @",simOperator:"];
  [ms appendFormat: @"\"%@\"", __simOperator];
  [ms appendString: @",mcc:"];
  [ms appendFormat: @"\"%@\"", __mcc];
  [ms appendString: @",mnc:"];
  [ms appendFormat: @"\"%@\"", __mnc];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__bluetoothEnabled_isset) {
    [outProtocol writeFieldBeginWithName: @"bluetoothEnabled" type: TType_BOOL fieldID: 1];
    [outProtocol writeBool: __bluetoothEnabled];
    [outProtocol writeFieldEnd];
  }
  if (__locationEnabled_isset) {
    [outProtocol writeFieldBeginWithName: @"locationEnabled" type: TType_BOOL fieldID: 2];
...
{
  self = [super init];
  if ([decoder containsValueForKey: @"free"])
  {
    __free = [decoder decodeInt32ForKey: @"free"];
    __free_isset = YES;
  }
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  if (__free_isset)
  {
    [encoder encodeInt32: __free forKey: @"free"];
  }
  if (__total_isset)
  {
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"StorageDetails"];
  if (__free_isset) {
    [outProtocol writeFieldBeginWithName: @"free" type: TType_I32 fieldID: 1];
    [outProtocol writeI32: __free];
    [outProtocol writeFieldEnd];
  }
  if (__total_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"StorageDetails("];
  [ms appendString: @"free:"];
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"storageDetails"])
  {
...
- (StorageDetails *) storageDetails {
  return [[__storageDetails retain_stub] autorelease_stub];
}

- (void) setStorageDetails: (StorageDetails *) storageDetails {
  [storageDetails retain_stub];
  [__storageDetails release_stub];
  __storageDetails = storageDetails;
  __storageDetails_isset = YES;
}

- (BOOL) storageDetailsIsSet {
  return __storageDetails_isset;
}

- (void) unsetStorageDetails {
  [__storageDetails release_stub];
  __storageDetails = nil;
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 26:
        if (fieldType == TType_STRUCT) {
          StorageDetails *fieldValue = [[StorageDetails alloc] init];
          [fieldValue read: inProtocol];
          [self setStorageDetails: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__storageDetails_isset) {
    if (__storageDetails != nil) {
      [outProtocol writeFieldBeginWithName: @"storageDetails" type: TType_STRUCT fieldID: 26];
      [__storageDetails write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  if (__countryCode_isset) {
